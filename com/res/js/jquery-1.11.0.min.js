...
!(function (a, b) {
      ...
      (d = db.selectors =
        {
          ...
          preFilter: {
            ...
            CHILD: function (a) {
              return (
                (a[1] = a[1].toLowerCase()), "nth" === a[1].slice(0, 3) ? (a[3] || db.error(a[0]), (a[4] = +(a[4] ? a[5] + (a[6] || 1) : 2 * ("even" === a[3] || "odd" === a[3]))), (a[5] = +(a[7] + a[8] || "odd" === a[3]))) : a[3] && db.error(a[0]), a
              );
            },
            PSEUDO: function (a) {
              var b,
  ...
  (n.event = {
    ...
    (n.Event = function (a, b) {
      return this instanceof n.Event
        ? (a && a.type
            ? ((this.originalEvent = a), (this.type = a.type), (this.isDefaultPrevented = a.defaultPrevented || (void 0 === a.defaultPrevented && (a.returnValue === !1 || (a.getPreventDefault && a.getPreventDefault()))) ? bb : cb))
            : (this.type = a),
          b && n.extend(this, b),
  ...
  function Gb(a) {
    ...
    return (
      c ||
        ((c = Fb(a, b)),
        ("none" !== c && c) || ((Db = (Db || n("<iframe frameborder='0' width='0' height='0'/>")).appendTo(b.documentElement)), (b = (Db[0].contentWindow || Db[0].contentDocument).document), b.write(), b.close(), (c = Fb(a, b)), Db.detach()),
        (Eb[a] = c)),
      c
    );
  }
