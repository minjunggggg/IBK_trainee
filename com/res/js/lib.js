$(document).ready(function () {
  ...
  if ($(".cmh_slide").length) {
    ...
    $(".cmhn_pagination .total").text(totalCount); // ��ü �����̵� �� ǥ��

    // �����̵� ���� ��, ���� �����̵� ��ȣ ����
    $(".cmh_slide.t1").on("beforeChange", function (event, slick, currentSlide, nextSlide) {
      var count = "0" + (nextSlide + 1);
      $(".cmhn_pagination .current").text(count); // ���� �����̵� ��ȣ ǥ�� (1���� ����)
      startProgressbar();
      if (!isPlaying) changeWhenPaused = true; // �Ͻ����� �����϶� �����̵� ��ȯ
    });
    startProgressbar();
    ...
    function startProgressbar() {
      ...
      percentTime = 0;
      if (isPlaying) {
        tick = setInterval(interval, 30); // �Ͻ����� ���°� �ƴϸ� �������?
      }
    }
    function interval() {
      if (isPlaying) {
